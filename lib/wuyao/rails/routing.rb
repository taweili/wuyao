    ...
    module Routing
      module RouteSetExtensions
        def self.included(base)
          base.alias_method_chain :extract_request_environment, :wuyao
        end

        def extract_request_environment_with_wuyao(request)
          env = extract_request_environment_without_wuyao(request)
